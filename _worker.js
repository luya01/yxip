...
// 设置优选地址api接口
let addressesapi = [
	'https://cf-workers-text2kv-blz.pages.dev/ip.txt?token=Xyhxsd1999', //可参考内容格式 自行raw生成。
	//'https://raw.githubusercontent.com/cmliu/WorkerVless2sub/main/addressesipv6api.txt', //IPv6优选内容格式 自行搭建。
];

let DLS = 4;//速度下限
let addressescsv = [
	'https://cf-workers-text2kv-blz.pages.dev/cesu.csv?token=Xyhxsd1999', //iptest测速结果文件。
];
